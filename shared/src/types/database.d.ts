...
export type ReportCategory = 'lighting' | 'unsafe_road' | 'suspicious' | 'harassment' | 'accident' | 'hazard' | 'crowd' | 'other';
...
export type FakeCallStatus = 'scheduled' | 'armed' | 'ringing' | 'answered' | 'declined' | 'missed' | 'cancelled';
